<footer id="site-footer" class="site-footer background four-columns" style="margin-top:20px;">
				<div class="footer">
								...
								<div class="row">
									...
									<div class="col-lg-3 col-md-6 column-2">
										<div class="block block-menu">
											<!-- <a href="#"><h1 style="margin-top: -7px;">LOGO</h1></a> -->
											<?php 
												$sql=mysqli_query($conn,"select * from information where id='2'");
												$result=mysqli_fetch_assoc($sql);
											?>
											<img src="images/<?php echo $result['data']; ?>">


											<?php 
												$sql=mysqli_query($conn,"select * from information where id='6'");
												$result=mysqli_fetch_assoc($sql);
											?>
											<p class="text-dark">
									...
									<div class="col-lg-3 col-md-6 column-1">
										<div class="block block-menu m-b-20">
											...
											<div class="block-content">
												<ul>
											<?php 
												$sql=mysqli_query($conn,"select * from information where id='5'");
												$result=mysqli_fetch_assoc($sql);
											?>
													<li>
														<span>Head Office:</span> <a href="#"><?php echo $result['data']; ?></a>
													</li>
													<?php 
												$sql=mysqli_query($conn,"select * from information where id='4'");
												$result=mysqli_fetch_assoc($sql);
											?>
													<li>
														<span>Tel:</span> <a href="callto:<?=$result['data']?>"><?php echo $result['data']; ?></a>
													</li>
											<?php 
												$sql=mysqli_query($conn,"select * from information where id='3'");
												$result=mysqli_fetch_assoc($sql);
											?>
													<li>
														<span>Email:</span> <a href="mailto:<?php echo $result['data']; ?>"><?php echo $result['data']; ?></a>
													</li>
												</ul>
											</div>
										</div>
											...
											<div class="block-content">
												<div class="block block-social">
													<ul class="social-link">
														<?php 
												$sql=mysqli_query($conn,"select * from information where id='8'");
												$result=mysqli_fetch_assoc($sql);
											?>
														<li><a href="<?php echo $result['data']; ?>" target="_blank"><i class="fa fa-twitter"></i></a></li>
														<?php 
												$sql=mysqli_query($conn,"select * from information where id='10'");
												$result=mysqli_fetch_assoc($sql);
											?>
														<li><a href="<?php echo $result['data']; ?>" target="_blank"><i class="fa fa-instagram"></i></a></li>
														<?php 
												$sql=mysqli_query($conn,"select * from information where id='7'");
												$result=mysqli_fetch_assoc($sql);
											?>
														<li><a href="<?php echo $result['data']; ?>" target="_blank"><i class="fa fa-facebook"></i></a></li>
														<?php 
												$sql=mysqli_query($conn,"select * from information where id='9'");
												$result=mysqli_fetch_assoc($sql);
											?>
														<li><a href="<?php echo $result['data']; ?>" target="_blank"><i class="fa fa-behance"></i></a></li>
													</ul>
												</div>
											</div>
										</div>
								...
								<div class="row">
									...
									<div class="col-md-6">
										<div class="footer-right">
											Developed By <a href="https://jetwebsolution.com/" target="_blank"> JETWEB SOLUTION</a>
										</div>
									</div>
								</div>
							</div>
                ...
                <div class="wishlist-popup-content">
						...
						<table class="wishlist-items">                        
							<tbody>
								<tr class="wishlist-item">
			                        ...
			                        <td class="wishlist-item-info">
										<div class="wishlist-item-name">
											<a href="javascript:void(0); ">Twin Hoops</a>
										</div>
								...
								<tr class="wishlist-item">
			                        ...
			                        <td class="wishlist-item-info">
										<div class="wishlist-item-name">
											<a href="javascript:void(0); ">Yilver And Turquoise Earrings</a>
										</div>
										<div class="wishlist-item-price">
                    ...
                    <div class="wishlist-popup-content-bot">
                        <div class="wishlist-popup-content-bot-inner">
                            <a class="wishlist-page" href="javascript:void(0);">
								Open wishlist page                                    
							</a>
                    		...
                    		<table id="product-table" class="product-table">
                    			<thead>
                    				<tr>
                    					...
                    					<th>
                    						<a href="javascript:void(0); ">Twin Hoops</a> <span class="remove">remove</span>
                    					</th>
                    					<th>
                    						<a href="javascript:void(0); ">Medium Flat Hoops</a> <span class="remove">remove</span>
                    					</th>
                    					<th>
                    						<a href="javascript:void(0); ">Bold Pearl Hoop Earrings</a> <span class="remove">remove</span>
                    					</th>
                    				</tr>
                    			</thead>
                    			<tbody>
